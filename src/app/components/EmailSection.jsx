...
const EmailSection = () => {
    ...
    return (
        <section className='grid md:grid-cols-2 my-12 py-24 gap-4 relative'>
            <div className='bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#3b38d9] to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-y-1/2'>..</div>
            <div className='z-10'>
                ...
                <div className='socials flex flex-row gap-2'>
                    <Link href="https://github.com/vermaanurag1532">
                        <Image src={GithubIcon} alt="GitHub" />
                    </Link>
                    <Link href="hhttps://www.linkedin.com/in/anurag-verma-471450224/">
                ...
                <form className='flex flex-col' onSubmit={handleSubmit}>
                    <div className='mb-6'>
                        ...
                        <input type="email" id='email' name='email' required
                            ...
                            placeholder='vermaanurag1532@gmail.com' />
                    </div>
                    <div className='mb-6'>
                    ...
                    <button type='submit'
                        className='bg-[#3b38d9] hover:bg-[#3f4ed9] text-white font-medium py-2.5 px-2.5 rounded-lg w-full h-10'>
                        Send Message
                    </button>
                </form>
            </div>
